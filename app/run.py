...
def index():
    ...
    message_category_counts = df[df.columns[4:]].sum().sort_values(ascending=False)
    category_name = df[df.columns[4:]].sum().sort_values(ascending=False).index
    ...
    graphs = [
        ...
        },
        {
            ...
            'layout': {
                'title': 'Counts of messages received',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
